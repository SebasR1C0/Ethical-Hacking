...
Vemos que el valor del parámetro pasa por un addslashes y despues va al eval. Tomar en cuenta que addslashes solo modifica estos caracteres especiales ' " \ y null

Tmabien tomar en cuenta que cada expresion que llega al eval se ejecuta.
